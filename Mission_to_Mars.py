...
# Find and click the full image button (the [1] indexing stipulates we want to click the second occurence of button in our list)
...
#export dataframe to html format for upload to site
df.to_html()

#turn of automated browser after finished web scraping 
browser.quit()
